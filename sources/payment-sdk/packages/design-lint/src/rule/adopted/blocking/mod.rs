...
use syn::{
    Block, Expr, ExprCall, ExprClosure, ExprMethodCall, ImplItemFn, ItemFn, ItemMod, ItemUse,
    Local, Pat, Stmt, spanned::Spanned, visit::Visit,
};
...
impl<'ast> Visit<'ast> for Blocking<'_> {
    ...
    fn visit_item_mod(&mut self, module: &'ast ItemMod) {
        ...
        self.test_depth += usize::from(test_only(&module.attrs));
